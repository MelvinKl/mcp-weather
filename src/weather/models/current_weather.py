...
class CurrentWeather(BaseModel):
    ...
    wind_speed: Union[StrictFloat, StrictInt]
    wind_direction: Union[StrictFloat, StrictInt]
    weather_code: StrictInt
    __properties: ClassVar[List[str]] = ["time", "temperature", "wind_speed", "wind_direction", "weather_code"]
