...
class TestWeatherSSEServer:
    ...
    @patch("main.WeatherAPI")
    @patch("main.FastMCP")
    def test_init_custom_host_and_port(self, mock_fastmcp_class, mock_weather_api_class):
    ...
    @patch("main.FastMCP")
    @patch("main.logger")
    def test_start_server(self, mock_logger, mock_fastmcp_class, mock_weather_api_class):
        ...
        mock_logger.info.assert_called_once_with("Starting MCP Weather Server on 0.0.0.0:8080 using streamable-http")
    ...
    @patch("main.WeatherAPI")
    @patch("main.FastMCP")
    def test_register_tools_filters_private_methods(self, mock_fastmcp_class, mock_weather_api_class):
    ...
    @patch("main.FastMCP")
    @patch("main.logger")
    def test_main_with_valid_transports(self, mock_logger, mock_fastmcp_class, mock_weather_api_class):
    ...
    @patch("main.logger")
    @patch("builtins.exit")
    def test_main_invalid_transport(self, mock_exit, mock_logger, mock_fastmcp_class, mock_weather_api_class):
        ...
        with patch.dict(os.environ, {"TRANSPORT": "invalid", "PORT": "8080", "HOST": "0.0.0.0"}):
            main()
    ...
    @patch("main.logger")
    @patch("builtins.exit")
    def test_main_custom_configuration(self, mock_exit, mock_logger, mock_fastmcp_class, mock_weather_api_class):
        ...
        with (
            patch("main.WeatherSSEServer.start"),
            patch.dict(os.environ, {"TRANSPORT": "sse", "PORT": "9090", "HOST": "192.168.1.1"}),
        ):
            main()
    ...
    @patch("main.FastMCP")
    @patch("main.logger")
    def test_start_logging_message(self, mock_logger, mock_fastmcp_class, mock_weather_api_class):
        ...
        expected_message = "Starting MCP Weather Server on 0.0.0.0:8080 using streamable-http"
